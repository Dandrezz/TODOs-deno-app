...
const TodoList = () => {
  ...
  const fetchTodos = async () => {
    const res = await fetch(URL_API_TODOS, {
      method: "GET",
    ...
    <>
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded mb-4 ml-auto"
        >
          Añadir
        </button>
      </div>
                      ...
                      {todo.editable
                        ? (
                          <button
                            ...
                            className={`${
                              todo.estado ? "bg-green-500" : "bg-orange-500"
                            } font-bold py-2 px-4 rounded text-white`}
                            defaultValue={todo.nombre}
                          >
